...
class Table extends React.Component {
  constructor(props) {
    ...
    this.onChangePage = (page, disabled) => () => {
      if (disabled) {
        return;
      }
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      width: width
    }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, columns.map((column, index) => this.renderHeaderColumn(column, index)))), /*#__PURE__*/React.createElement("tbody", null, dataRender.slice(currentPage * pageSize, currentPage * pageSize + pageSize).map(record => /*#__PURE__*/React.createElement("tr", null, columns.map(column => this.renderCell(record, column)))))))), /*#__PURE__*/React.createElement("div", {
      className: bootstrap.row
    }, /*#__PURE__*/React.createElement("div", {

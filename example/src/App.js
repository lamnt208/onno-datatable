...
const App = () => {
	return (
		...
		>
			...
			<Column label="Office" field="Office" sortable={true} />
			<Column label="Age" field="Age" sortable={true} />
			<Column label="Start date" field="Startdate" sortable={true} />
			<Column label="Salary" field="Salary" sortable={true} />
		</Table>
	);
	...
	// 		filterable={true}
	// 	>
	// 		<Column label="Id" field="id" sortable={true} />
	// 		<Column label="User Id" field="userId" sortable={true} />
	// 		<Column label="Title" field="title" sortable={true} />
	// 		<Column label="Completed" field="completed" sortable={true} render={(each) => each.completed ?
	// 			(<label>Yes</label>) :
	// 			(<label>No</label>)} />
	// 	</Table>
	// );
